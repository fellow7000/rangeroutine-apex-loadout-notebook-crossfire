...
<div align="center">
  <img src="./public/logo.svg" alt="RangeRoutine — Apex Legends — Crossfire" width="64" height="64">
  <h1>RangeRoutine — Apex Legends — Crossfire</h1>
</div>

Каталог ручных сравнений оружия и тренировочных упражнений.
...
<td align="center">
<h3>Обзор проекта</h3>
<img src="./public/screenshots/desktop-main.svg" alt="Apex Legends — desktop concept, not a screenshot" width="520">
<br>
<em>Три запланированных модуля</em>
</td>
<td align="center">
<h3>Компактное представление</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Apex Legends — compact concept, not a screenshot" width="250">
<br>
...
- **Loadout comparison sheets** — запланированный модуль; реализации нет.
- **Firing range drill cards** — запланированный модуль; реализации нет.
- **Season change journal** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Loadout comparison sheets**.
...
Только ручной ввод и разрешенные пользователем данные после сессии. Без чтения памяти игры, скрытых сведений о соперниках, автоматизации ввода и изменения игрового клиента.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="RangeRoutine — Apex Legends — Crossfire — specification review workflow">
<br>
...
### Loadout comparison sheets

Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Apex Legends, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Firing range drill cards

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Apex Legends, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Season change journal

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Apex Legends, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Apex Legends |
| Категория | Ручные игровые помощники |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Loadout comparison sheets |

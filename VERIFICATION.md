# Verification plan — Apex Legends

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Loadout comparison sheets

- [ ] Define a versioned input fixture specifically for loadout comparison sheets.
...
### 2. Firing range drill cards

- [ ] Define a versioned input fixture specifically for firing range drill cards.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Season change journal

- [ ] Define a versioned input fixture specifically for season change journal.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

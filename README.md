...
An independent project specification for Apex Legends, covering loadout comparison sheets, firing range drill cards, season change journal.
...
- **Loadout comparison sheets** — planned module; not implemented.
- **Firing range drill cards** — planned module; not implemented.
- **Season change journal** — planned module; not implemented.

The proposed workflow separates loadout comparison sheets from firing range drill cards, with season change journal retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Loadout comparison sheets**.
...
Define the input and expected outcome for module 1. Record the Apex Legends version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Firing range drill cards

Define the input and expected outcome for module 2. Record the Apex Legends version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Season change journal

Define the input and expected outcome for module 3. Record the Apex Legends version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Loadout comparison sheets |
